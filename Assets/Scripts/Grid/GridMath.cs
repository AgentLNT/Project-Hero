...
namespace ProjectHero.Core.Grid
{
    ...
    {
        public static GridDirection GetDirection(GridPoint from, GridPoint to)
        {
        ...
        public static GridPoint GetNeighbor(GridPoint start, GridDirection dir)
        {
            int dx = 0;
            int dy = 0;
            switch (dir)
            ...
            return new GridPoint(start.X + dx, start.Y + dy);
        }
